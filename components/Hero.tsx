...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative bg-orange-50 overflow-hidden pt-16 pb-24 md:pt-24 md:pb-32">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 text-center md:text-left z-10">
          <div className="flex flex-col md:flex-row md:space-x-2 space-y-2 md:space-y-0 mb-6 items-center md:items-start">
            <span className="inline-block px-4 py-1 rounded-full bg-orange-200 text-orange-700 font-bold text-xs">
              Seg-Sáb: 08:00 às 19:00
            </span>
            <span className="inline-block px-4 py-1 rounded-full bg-orange-100 text-orange-600 font-bold text-xs border border-orange-200">
              Dom: 09:00 às 14:00
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-center md:justify-start">
            <a href="#services" className="bg-orange-500 text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-lg hover:bg-orange-600 hover:-translate-y-1 transition-all">
              Ver Serviços
            </a>
            <a href="#products" className="bg-white text-orange-600 border-2 border-orange-500 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-orange-50 transition-all">
              Comprar Rações
            </a>
          </div>
        </div>
